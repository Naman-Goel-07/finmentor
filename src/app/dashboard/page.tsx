...
import { AlertCircle, ArrowUpRight, DollarSign, Activity } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto w-full">
      ...
      <div className="mt-8 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-6 border-b border-gray-100 flex justify-between items-center">
           ...
           <Link href="/expenses" className="text-blue-600 text-sm font-medium">See all</Link>
        </div>
        <div className="p-0">
               ...
               {recentExpenses.map((exp, idx) => (
                 <div key={idx} className="p-4 px-6 flex justify-between items-center hover:bg-gray-50 transition-colors">
                    <div className="flex flex-col">
                       ...
                       <span className="text-sm text-gray-500">{exp.note || 'No description'} &bull; {new Date(exp.date).toLocaleDateString()}</span>
                    </div>
